...
gem_version =
  if RUBY_VERSION >= "3.1" # rubocop:disable Gemspec/RubyVersionGlobalsUsage
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/markdown/merge/version.rb", mod) }::Markdown::Merge::Version::VERSION
  else
    ...
    require "markdown/merge/version"
    Markdown::Merge::Version::VERSION
  end
