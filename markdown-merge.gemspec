...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/markdown/merge/version.rb", mod) }::Markdown::Merge::Version::VERSION
  ...
  spec.metadata["homepage_uri"] = "https://markdown-merge.galtzo.com/"
  ...
  # The 'git' gem is optional; markdown-merge falls back to shelling out to `git` if it is not present.
