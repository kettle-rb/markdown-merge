...
# kettle-jem:freeze
# To retain chunks of comments & code during markdown-merge templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# markdown-merge will then preserve content between those markers across template runs.
# kettle-jem:unfreeze

# markdown-merge Rakefile v1.0.0 - 2026-04-03
...
# rake install                                # Build and install markdown-merge-1.0.0.gem in...
# rake install:local                          # Build and install markdown-merge-1.0.0.gem in...
# rake kettle:jem:install                     # Install markdown-merge GitHub automation and ...
# rake kettle:jem:selftest                    # Self-test: template markdown-merge against itse...
# rake kettle:jem:template                    # Template markdown-merge files into the curren...
